...
// ─────────────────────────────────────────────
// ✅ ALLOWED ADMIN EMAILS — add new ones here
// ─────────────────────────────────────────────
const ALLOWED_ADMIN_EMAILS: string[] = [
  'andrewkal327@gmail.com',
    ...
    const checkAuth = async () => {
      ...
      if (user) {
        ...
        if (!ALLOWED_ADMIN_EMAILS.includes(email)) {
          // Signed in with Google but not an allowed admin — sign them out
          await supabase.auth.signOut()
          setError(`Access denied. ${email} is not an authorized admin account.`)
          return
        }
